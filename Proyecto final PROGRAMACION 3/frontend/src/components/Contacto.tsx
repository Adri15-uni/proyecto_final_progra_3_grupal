        ...
        <Container maxWidth="sm">
          ...
          >
            ...
            <Typography variant="body1" align="center" gutterBottom>
              Estamos aquí para ayudarte siempre. ¡No dudes en contactarnos!
            </Typography>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, width: '100%', maxWidth: 300 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <Typography variant="body1">
                  Correo Electrónico: <Link href="mailto:info@deliciasdeensueno.com" color="secondary">info@inmobiliariasolares.com</Link>
                </Typography>
              </Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <Typography variant="body1">
                  Teléfono: <Link href="tel:+1234567890" color="secondary">+1 (809) 567-2410</Link>
                </Typography>
              </Box>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'center', gap: 2 }}>
                <IconButton color="primary" aria-label="Facebook" href="https://www.facebook.com/DeliciasDeEnsueeno" target="_blank" rel="noopener noreferrer">
                  <FacebookIcon fontSize="large" />
                </IconButton>
                <IconButton color="primary" aria-label="Instagram" href="https://www.instagram.com/DeliciasDeEnsueeno/" target="_blank" rel="noopener noreferrer">
